...
void LCD_ShowChar(u16 x,u32 y,u8 num,u8 size,u8 mode);					//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size);  					//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);	//显示多个 数字
void LCD_ShowString(u16 x,u32 y,u8 size,u8 *p);	                //显示一个字符串,12/16/24字体(width height 没有用)
void LCD_ShowString_N(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p);
void PutHZ3232(unsigned short x, unsigned short  y, unsigned char c[2], unsigned int dcolor,unsigned int bgcolor); //显示单个汉字32*32
//void PutHZ6464(unsigned short x, unsigned short  y, unsigned char c[2], unsigned int dcolor,unsigned int bgcolor);//显示单个汉字64*64
void showhz32str(unsigned int x1,unsigned int y1,unsigned char *str,unsigned int dcolor,unsigned int bgcolor);//显示多个汉字32*32
void showhfstr(unsigned int x1,unsigned int y1,unsigned char *str,unsigned int dcolor,unsigned int bgcolor);//显示多个汉字16*16	 
//void showhz64str(unsigned int x1,unsigned int y1,unsigned char *str,unsigned int dcolor,unsigned int bgcolor); //显示多个汉字64*64	 
